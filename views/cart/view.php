            ...
            <table class="table table-hover table-striped" id="cart-table">
                ...
                <?php foreach ($session['cart'] as $id => $item): ?>
                    <tr>
                        ...
                        <td><a href="<?= Url::to(['/cart/change-qty', 'id' => $id, 'change' => 'plus', 'currentQty' => $item['qty']]) ?>"><i class="fa fa-plus-square"></i></a> <?= $item['qty'] ?> <a href="<?= Url::to(['/cart/change-qty', 'id' => $id, 'change' => 'minus', 'currentQty' => $item['qty']]) ?>"><i class="fa fa-minus-square"></i></a></td>
                        <td><?= $item['cost'] ?></td>
